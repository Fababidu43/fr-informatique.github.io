...
function head({ title, description, url, schema, image = "meca-europe-new.webp", imageWidth = 1600, imageHeight = 791, imageAlt = "FR Informatique, développeur indépendant à Beauzac" }) {
...
const localBusiness = {
  ...
  image: [`${domain}/assets/img/profile-img.jpg`, `${domain}/assets/img/meca-europe-new.webp`],
